      ...
      <div className="mycontainer">
        ...
        <div className="">
          <p className="py-2 font-light">
            ...
            commodities that makes exchanging straightforward, and surprisingly
            fun, utilizing realistic portrayals for successful trading. we serve
            as a go-between among purchasers and dealers of the commodities(gold
            and crude oil) in the stock market while allowing our users to
            invest at their speed.
          </p>
          <p className="py-2 font-light">
            MetalCharts dispatches its cutting-edge, instinctive trading
            platform, empowering everybody to trade financial assets online. We
            have the radical thought that anybody at any place should have the
            option to effectively and safely access the commodity market. We see
            commodities like gold as the fate of cash and an impetus for making

      ...
      <div className="bg-primary pt-4">
        <div className="mycontainer">
          <div className="flex flex-col items-start justify-between lg:flex-row">
            <div className="my-2 lg:my-0 w-full lg:w-1/4 text-white font-light">
            ...
            <div className="my-2 lg:my-0 w-full lg:w-1/4 lg:ml-4">
            ...
            <div className="my-2 lg:my-0 w-full lg:w-1/4">
              <h3 className="text-xl font-medium text-yellow-500">Social Handles</h3>
              <div className="flex flex-col">
                <Link href="https://wa.link/3ypjta">
                  <a className="nav-item" target="_blank">WhatsApp</a>
                </Link>

                <Link href="https://t.me/MetalChartsVIP">
                  <a className="nav-item" target="_blank">Telegram</a>
                </Link>

                <Link href="https://www.instagram.com/metal_charts/">
                  <a className="nav-item" target="_blank">Instagram</a>
                </Link>

                
                <Link href="https://twitter.com/MetalCharts">
                  <a className="nav-item" target="_blank">Twitter</a>
                </Link>
              </div>
            </div>
